...
void checkPangram(char text[500]) {
    ...
    if (characterSum == 2847) {
        printf("The text is a pangram");
    }
    else {
        printf("The text is not a pangram");
    }
}
...
int main() {
    ...
    printf("This program checks whether a text is a pangram.\n");
    printf("A pangram contains every letter of the English alphabet.\n\n");

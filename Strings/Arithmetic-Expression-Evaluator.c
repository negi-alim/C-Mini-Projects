...
int main() {
    ...
    printf("This program evaluates an arithmetic expression using variables.\n");
    printf("Enter an expression using variables and +, -, *, or /:\n");
    ...
    printf("\nEnter a numeric value for each variable:\n");
